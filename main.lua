...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://134334463722355",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=134334463722355";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Description = "Tại Đây",
    Callback = function()
        setclipboard("https://www.youtube.com/@shitv1155");
    end
});
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://134334463722355") then
                    return v729;
                end
            end
        end
